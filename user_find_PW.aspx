<%@ Page Title="" Language="C#" MasterPageFile="Index.master" AutoEventWireup="true" CodeFile="user_find_PW.aspx.cs" Inherits="ASP_Project2_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="Find_Center">
        <div id="Find_Border">
            <div>
                <asp:Label ID="ment" runat="server">가입시 입력한 아이디,이메일을 입력해주세요.</asp:Label>
            </div>
            <hr />
            <asp:TextBox ID="find_info_TI" runat="server" placeholder="ID" MaxLength="50"></asp:TextBox>
            <asp:TextBox ID="find_info_T" runat="server" placeholder="Email" MaxLength="50"></asp:TextBox>
            ...
            <asp:Label runat="server" ID="Resultlbl" Text="회원님의 패스워드는 " Visible="false"></asp:Label>
