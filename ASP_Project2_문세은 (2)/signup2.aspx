        ...
        <div class="container">
            ...
            <div id="signupalgincenter">
                ...
                <section class="signup-top">
                    <asp:ImageButton ID="ImageButton1" ImageUrl="Images/logo55.png" OnClick="ImageButton1_Click" Width="300px" runat="server" />
                </section>
            </div>

            <p style="text-align: center;"> 
            <asp:Image ID="join_process" runat="server" ImageUrl="~/Images/step2.png" Width="950px" Height="150px"/>
                </p>
            ...
            <section class="signup-mid">
                ...
                <fieldset class="py-4">
                    ...
                    <asp:Button runat="server" ID="IDCheck" Text="중복체크" onClick="IDCheck_Click" CssClass="btn_id_check"/>
                    ...
                    <asp:Button runat="server" ID="NickCheck" Text="중복체크" onClick="NickCheck_Click" CssClass="btn_nick_check"/>
                    ...
                    <%--전화번호 DropDownList--%>
                    <asp:DropDownList runat="server" ID="phone" OnSelectedIndexChanged="phoneList_OnSelectedIndexChanged" AutoPostBack="True" CssClass="dropdown_mobile">
