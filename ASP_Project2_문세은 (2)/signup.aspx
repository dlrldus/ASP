...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Image ID="join_process" runat="server" ImageUrl="~/Images/step1.png" Width="950px" Height="150px"/>
             </p>
...
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 중헌책 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 중헌책는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다."></asp:TextBox>
                ...
                <asp:Button ID="Button1" runat="server" Text="취소" Height="80px" Width="227px" CssClass="btn_cancel_input"/>
                <asp:Button ID="Button2" runat="server" Text="다음" Height="80px" Width="227px" OnClick="Button2_Click" CssClass="btn_next_input"/>
          </p>
            </section>
