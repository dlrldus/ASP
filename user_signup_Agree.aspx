...
<body class="signup_body">
    <form id="form1" runat="server">
        <header>
            ...
            <div class="col-3"></div>
            <section class="col-6">
                <asp:Image ID="join_process" runat="server" ImageUrl="Images/Gstep1.png" Width="100%" Height="150px"/>
                ...
                <div class="container">
                <div id="sign_up1_Cen">
                <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="False" OnCheckedChanged="Checkbox1_Check"/>
                ...
                <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Height="300px" Width="80%" ReadOnly="True"
                    ...
                    1. 수집하는 개인정보이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 중헌책 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 중헌책는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다."></asp:TextBox>
