<%@ Page Title="" Language="C#" MasterPageFile="Index.master" AutoEventWireup="true" CodeFile="find_User_PW.aspx.cs" Inherits="ASP_Project2_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="Find_Center">
        <div id="Find_Border">
            ...
            <hr />
            <asp:TextBox ID="find_info_TI" runat="server" placeholder="ID" MaxLength="20"></asp:TextBox>
