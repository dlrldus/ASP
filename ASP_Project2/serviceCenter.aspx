    ...
    <div class="container">
        <table border ="1" style="width:100%;height:100px;font-size:22pt;text-align:center;">
            <tr>
                ...
                <td>
                    문제가 있는 사용자가 있나요?<br />
                    <asp:Button runat="server" text="신고 글 작성" BorderStyle="Dotted" BorderWidth="4px" OnClick="btnReport_Click" />
                    <asp:ImageButton runat="server" ImageUrl="~/ASP_Project2/icon/anger.png" ImageAlign="Middle" Width="50%" Height="170px" OnClick="btnReport_Click"/>
                </td>
            </tr>
        </table>
        <br />
