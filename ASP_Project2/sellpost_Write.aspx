                ...
                <div class="row">--%>
                    ...
                    <br />
                     <asp:Table ID="Table1" runat="server" CssClass="table">
                         ...
                         <asp:TableRow>
                             <asp:TableCell CssClass="column_text">
                                 <asp:Label ID="Label17" runat="server" Text="도서명"></asp:Label>
                             </asp:TableCell>
                             <asp:TableCell>
                                 <asp:TextBox ID="bookname" runat="server" Placeholder="도서명을 입력해주세요" CssClass="sell_right" Width="70%"></asp:TextBox>
                             </asp:TableCell>
                         </asp:TableRow>
                         <asp:TableRow>
                             <asp:TableCell CssClass="column_text">
