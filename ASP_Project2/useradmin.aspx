<%@ Page Title="" Language="C#" MasterPageFile="Index.master" AutoEventWireup="true" CodeFile="useradmin.aspx.cs" Inherits="ASP_Project2_Default" %>
            ...
            <Columns>
               ...
               <%-- <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center" HeaderText="관리자 권한부여">
                ...
                <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center" HeaderText="권한부여">
                    <ItemTemplate>
                        <asp:Button ID="ChangeGrant" runat="server" Text="관리자권한부여" Height="67px" CommandName="Update"/>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
