                        ...
                        <div class="row">
                            <div class="col">
                                <asp:Panel ID="Panel1" runat="server" CssClass="signup_panel py-3">
                                             ...
                                             <asp:Panel ID="Panel2" runat="server" CssClass="signup_panel2 py-3">
                                                 ...
                                                 <div class="row">
                                                    <div class="col-1"></div>
                                                        ...
                                                        <div class="col-5">
                                                             <asp:ImageButton ID="ImageButton3" runat="server" OnClick="Btn_Goods_Click" ImageUrl="~/ASP_Project2/Images/goods.png" Width="100%"/>
                                                            <br /><br /><br />
                                                        </div>
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="메인으로" CssClass="signup_success_main" onclick="Btn_Click"/>
                                    <br /><br />
                                </asp:Panel>
                            </div>
                        </div>
