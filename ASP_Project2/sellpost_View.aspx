        ...
        <%--<div id="View_Contents">--%>
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="tg-0lax" colspan="4" >
                                ...
                                <asp:Label runat="server" ID="bookname" Text=""></asp:Label>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="tg-0lax" colspan="4" >
                                <asp:Label runat="server" ID="Label2" Text="가격 :   "></asp:Label>
                                 <asp:Label runat="server" ID="hopeprice" Text=""></asp:Label>
                            </td>
                        </tr>
                    </thead>
                </table>            
            ...
            <div id="recommend" style="margin-top: 20px">
                ...
                <asp:GridView ID="reply_grid" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
                    AllowPaging="True" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AllowSorting="True" HorizontalAlign="Center" Width="100%" PageSize="4" OnPageIndexChanging="reply_grid_PageIndexChanging">
                    <Columns>
