...
<%--        <asp:Button runat="server" Text="회원 정보" Width="200px" Height="80px" />
        ...
        <hr />
        <asp:Button runat="server" Text="문의하기" Width="200px" Height="80px" OnClick="Qna_Click"/>
        <asp:Button runat="server" Text="신고하기" Width="200px" Height="80px" OnClick="Service_center_Click"/>
