...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="imageboard">
        ...
        <asp:GridView ID="requestpost_View"  GridLines="none" runat="server" AutoGenerateColumns="False" DataKeyNames="num"
            AllowPaging="True" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" AllowSorting="True" HorizontalAlign="Center" Width="90%" CssClass="table table-hover" CellPadding="4" Font-Size="13pt">
