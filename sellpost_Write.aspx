            ...
            <fieldset class="py-4" style="border: solid #996600; background-color: #f5f6f7">
                <div class="row">
                    ...
                    <div class="col-11">
                        ...
                        <asp:TextBox ID="title" runat="server" Placeholder="제목을 입력하세요" CssClass="sell_right" Width="76%"></asp:TextBox><br />
                        <br />
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <asp:Label runat="server" Text="*체크할경우 해당 판매글에는 판매자의 위치가 게시글에 등록됩니다.<br>(구매자가 판매자의 위치를 파악하여 신속한 직거래가 가능합니다.)" Font-Bold="False" ForeColor="Red" Font-Size="9pt"></asp:Label>
