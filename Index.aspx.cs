...
public partial class Main : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Response.Write("<script language=javascript>window.open('popup.aspx', '작업진행도', 'width =930, height=430, toolbar=no, menubar=no, scrollbars=no,directories=no,status=no');</script>");
