...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="imageboard">
        ...
        <asp:Label runat="server" Text="요청게시판" Font-Size="42pt" Font-Bold="True"></asp:Label><br />
        <br />
        ...
        <asp:GridView ID="requestpost_View" runat="server" AutoGenerateColumns="False" DataKeyNames="num"  EnableModelValidation="True"
            AllowPaging="True" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AllowSorting="True" HorizontalAlign="Center" Width="90%">
            <Columns>
