<%@ Page Title="" Language="C#" MasterPageFile="Site.master" AutoEventWireup="true" CodeFile="request_View.aspx.cs" Inherits="ASP_Project2_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="View_Container">
        <div id="top_Btn">
            ...
            <asp:Button ID="Button2" runat="server" Text="수정" CssClass="View_BtnT" OnClick="Update_Btn_Click"/><br />
            <br />
            <br />
        </div>
        <div id="View_header">
            <%--제목--%>
            <asp:TextBox ID="title" runat="server" CssClass="title_textbox" ReadOnly="true"></asp:TextBox><br />
            <br />
            <%--작성자 작성일 조회수 --%>
            <asp:Label ID="nickname" runat="server" Text="" CssClass="label_text2" ></asp:Label>
            <asp:Label ID="writeday" CssClass="label_text2" runat="server" Text=""></asp:Label>
            <asp:Label ID="readcount" CssClass="label_text2" runat="server" Text=""></asp:Label>
            <br />
            <br />
            <br />
            <br />
                ...
                <table style="width: 100%; height: 40px; background-color: white;">
                    <tr>
                        <td style="width: 10%; text-align: center;">
                            <asp:Label runat="server" ID="recommend_label" Width="100%" Text="댓글작성"></asp:Label>
                        </td>
                        <td style="width: 80%;">
