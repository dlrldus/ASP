...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="imageboard">
       ...
       <asp:GridView ID="sellpost" runat="server" AutoGenerateColumns="False" DataKeyNames="num"
            AllowPaging="True" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" HorizontalAlign="Center" Width="100%" OnPageIndexChanging="sellpost_PageIndexChanging" OnRowDataBound="sellpost_RowDataBound">
            <Columns>
